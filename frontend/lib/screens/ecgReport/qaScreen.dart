...
class ECGQuestionsScreen extends StatelessWidget {
  ...
  Future<void> _generatePDF(BuildContext context) async {
    ...
    try {
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          [
            pw.Header(
              level: 0,
              child: pw.Text('ECG Analysis Report',
                  style: pw.TextStyle(
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Text('Health Risk Assessment',
                      style: pw.TextStyle(
                          fontSize: 18, fontWeight: pw.FontWeight.bold)),
                  pw.SizedBox(height: 10),
                  pw.Text('Health Score: $healthScore'),
                  pw.Text('Risk Level: $riskLevel'),
                  pw.Text('Risk Probability: ${riskProbability.toStringAsFixed(
                      1)}%'),
                ],
              ),
            ),
            ...
            pw.Header(
              level: 1,
              child: pw.Text('Detailed Analysis',
                  style: pw.TextStyle(
                      fontSize: 18, fontWeight: pw.FontWeight.bold)),
            ),
      ...
      final file = File('${downloadsDir.path}/report_$timestamp.pdf');
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      'Risk Probability: ${riskProbability.toStringAsFixed(
                          1)}%',
                      style: TextStyle(
                        fontSize: 16,
...
Widget _buildRiskIndicator(String label,
    String value,
    Color color,
    IconData icon,) {
  return Column(
