...
class _HealthRecordsScreenState extends State<HealthRecordsScreen> {
            ...
            children: [
              Icon(
                record['risk_level'] == 'High'
                    ...
                    : Icons.check_circle,
                color:
                    record['risk_level'] == 'High' ? Colors.red : Colors.green,
                size: 24,
              ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildMetricRow(
                          'Heart Rate',
                          '${record['user_data']['heart_rate']} bpm',
                          Icons.favorite,
                        ),
                        _buildMetricRow(
                          'Blood Sugar',
                          '${record['user_data']['blood_sugar']} mg/dL',
                          Icons.water_drop,
                        ),
                        _buildMetricRow(
                          'Height',
                          '${record['user_data']['height']} cm',
                          Icons.height,
                        ),
                        _buildMetricRow(
                          'Weight',
                          '${record['user_data']['weight']} kg',
                          Icons.monitor_weight,
                        ),
                        _buildMetricRow(
                          'Cholesterol',
                          '${record['user_data']['cholesterol']} mg/dL',
                          Icons.science,
                        ),
                        _buildMetricRow(
                          'BMI',
                          '${record['user_data']['bmi'].toStringAsFixed(1)}',
                          Icons.calculate,
                        ),
                        _buildMetricRow(
                          'BMI Category',
                        ...
                        _buildMetricRow(
                          'Smoking',
                          record['user_data']['smoking'] == 1 ? 'Yes' : 'No',
                          Icons.smoking_rooms,
                        ),
                        _buildMetricRow(
                          'Alcohol',
                          record['user_data']['alcohol'] == 1 ? 'Yes' : 'No',
                          Icons.local_bar,
                        ),
                      ],
                    ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Health Records', showHomeButton: true),
      body:
          _isLoading
              ...
              ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      'Complete a health assessment to see your records here.',
                    ),
                    const SizedBox(height: 16),
                    ElevatedButton(
                      onPressed: () {
